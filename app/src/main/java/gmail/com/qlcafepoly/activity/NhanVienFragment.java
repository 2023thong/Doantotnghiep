...
import gmail.com.qlcafepoly.activity.DoiMatKhauNv;
...
//        tvCaLam.setText(MaCL);
        ...
        Sukien();
        String imageUrl = "http://192.168.1.90/duantotnghiep/layhinhanh.php?MaNv=" +Manv;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bitmap != null){
                    ...
                    String url ="http://192.168.1.90/duantotnghiep/database.php";
