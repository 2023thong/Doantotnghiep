...
public class DoiMatKhauNv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doi_mat_khau_nv);
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mkmoi1.equals(mkmoi)) {
                    Toast.makeText(DoiMatKhauNv.this, "Mật khẩu mới không giống nhau", Toast.LENGTH_SHORT).show();
                }
